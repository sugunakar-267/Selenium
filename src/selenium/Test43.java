...
public class Test43 
{
	public static void main(String[] args) throws Exception
	{
		...
		System.out.println("Unread mails count is "+eurm);
		System.out.println("Read mailscount is "+erm);
		//Test Case - 1: All mails count test
		String txt1 = driver.findElement(By.xpath("//*[aria-label='show more messages']/descendent::span[5]")).getText();
		int aam = Integer.parseInt(txt1);
		//Test Case - 2: All unread mails count test
		String txt2 = driver.findElement(By.xpath("//*[data-tooltip='Inbox']/descendent::div[4]")).getText();
